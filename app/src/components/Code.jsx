    ...
    >
      <span
        ...
        className={clsx(
          ...
          copied && '-tranzinc-y-1.5 opacity-0',
        )}
      >
...
function CodePanelHeader({ tag, label }) {
  ...
  return (
    <div className="flex h-9 items-center gap-2 border-y border-b-white/7.5 border-t-transparent bg-white/2.5 bg-zinc-700 px-4 dark:border-b-white/5 dark:bg-white/1">
      {tag && (
