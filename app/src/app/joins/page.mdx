...
1. **Be as explicit with columns** being included in each dataset before you join.{{ className: "lead" }}
2. **If you are joining on the exact same columns in both dataframes**, use the "simple" method.{{ className: "lead" }}
3. **If you have to do "complex" joins, use expressions and aliasing** your dataframes. (See below){{ className: "lead" }}
