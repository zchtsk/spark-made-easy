...
One method for making changes to a dataframe is to create or update a dataframe with each step.{{ className: "lead" }}
...
Another method is to chain the updates together. This is a bit more concise, but at the expense of being a bit more complex to debug.{{ className: "lead" }}
