...
There are two general flavors of UDFs: (1) **Standard Spark UDFs** which use native python (2) **Pandas UDFs** which pass your selects data to a pandas dataframe.
...
Pandas UDFs allow you to pass your data to pandas operations in a highly efficient manner. For more information [see here](https://docs.databricks.com/en/udf/pandas.html).
